...
List<Map<String, dynamic>> toursData = [
  {
    ...
    "country": "Италия",
    "image":
        "https://firebasestorage.googleapis.com/v0/b/travel-season-54aac.appspot.com/o/tours%2F1.jpg?alt=media&token=44ccd9b9-cbc5-4ff9-909c-c311277a816c"
  },
  {
    "name": "Осенние краски Киото",
    "description":
        "10-дневный тур по Киото с проживанием в Hyatt Regency Kyoto. Погрузитесь в японскую культуру, посетите древние храмы и сады, насладитесь красотой осенней листвы.",
    "price": 2200,
    ...
    "country": "Япония",
    "image":
        "https://firebasestorage.googleapis.com/v0/b/travel-season-54aac.appspot.com/o/tours%2F2.jpg?alt=media&token=857b18e5-a274-49b1-92fa-1a5d85183d70"
  },
  {
    ...
    "country": "Кения",
    "image":
        "https://firebasestorage.googleapis.com/v0/b/travel-season-54aac.appspot.com/o/tours%2F3.jpg?alt=media&token=c3548c8f-ab2d-4c95-a4ed-920e91006438"
  },
  // ... остальные туры
];
...
Future<void> prefillData() async {
  ...
  for (var i = 0; i < toursData.length; i++) {
    ...
    try {
      ...
      // Теперь "country" - просто строка, представляющая название страны
